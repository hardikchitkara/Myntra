    ...
    return (
      <div>
        ...
        <div id="stop-scroll">
          ...
          <div className="mid">
            <div className="mid_1">
              Home / Clothing / {this.state.sex} Clothing /
              <span className="mid_1_3">
                Shirts / {this.state.brand} Shirts /
              </span>
            </div>
          </div>
          <div className="display">
            ...
            <div className="detailsdisplay">
              ...
              <div className="buttons">
                ...
                >
                  <span class="size-buttons-size-strike-hide"></span>
                  <p class="size-buttons-unified-size">M</p>
                </button>
                <button
                  id="L"
                  class="size-buttons-size-button size-buttons-size-button-default"
                ...
                >
                  <span class="size-buttons-size-strike-hide"></span>
                  <p class="size-buttons-unified-size">XL</p>
                </button>
                <button
                  id="XXL"
                  class="size-buttons-size-button size-buttons-size-button-default"
                ...
                >
                  <span class="size-buttons-size-strike-hide"></span>
                  <p class="size-buttons-unified-size">XXL</p>
                </button>
                <button
                  id="XXXL"
                  class="size-buttons-size-button size-buttons-size-button-default"
                ...
                >
                  <span class="size-buttons-size-strike-hide"></span>
                  <p class="size-buttons-unified-size">XXXL</p>
                </button>
              </div>
